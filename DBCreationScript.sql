...
create table product(id int not null unique, name varchar(100) not null unique, quantity int not null, minimalPrice decimal(6,2) not null, actualPrice decimal(6,2) not null, priceInSale decimal(6,2), blackFridaySalePercentage decimal(4,2), blackFriday bool default false, primary key(id));
